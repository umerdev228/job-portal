            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <Link
                        ...
                        :class="{
                            'bg-gray-700 ': route().current('admin.dashboard*'),
                        }"
                    >
                        <svg
                            aria-hidden="true"
                ...
                <li>
                    <Link
                        ...
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                        :class="{
                            'bg-gray-700 ': route().current('admin.roles.*'),
                        }"
                    >
                        <svg
                ...
                <li>
                    <Link
                        ...
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                        :class="{
                            'bg-gray-700 ': route().current('admin.skills.*'),
                        }"
                    >
                        <svg
                            class="w-6 h-6 text-gray-800 dark:text-white"
                ...
                <li>
                    <Link
                        ...
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                        :class="{
                            'bg-gray-700 ': route().current('admin.degrees.*'),
                        }"
                    >
                        <svg
                            class="w-6 h-6 text-gray-800 dark:text-white"
                ...
                <li>
                    <Link
                        ...
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                        :class="{
                            'bg-gray-700 ': route().current('admin.cities.*'),
                        }"
                    >
                        <svg
                            class="w-6 h-6 text-gray-800 dark:text-white"
                ...
                <li>
                    <Link
                        ...
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                        :class="{
                            'bg-gray-700 ': route().current('admin.jobs.*'),
                        }"
                    >
                        <svg
                            class="w-6 h-6 text-gray-800 dark:text-white"
                ...
                <li>
                    <Link
                        :href="route('admin.meta.edit')"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                        :class="{
                            'bg-gray-700 ': route().current('admin.meta.*'),
                        }"
                    >
                        <svg
                            class="w-6 h-6 text-gray-800 dark:text-white"
