        ...
        <div class="grid grid-cols-4 md:grid-cols-4 gap-4">
            <div v-for="job in jobs.data"
                ...
                <div class="p-5">
                    ...
                    <Link v-if="auth.user && auth.applied_jobs.find(j => j === job.id)" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-gray-400 dark:focus:ring-blue-800"
                          disabled>
                        Applied
                    </Link>
                    <Link v-else
