...
const props = defineProps({
 ...
 const toggleStatus = (cityId,newValue)=>{
    Inertia.put(route('admin.cities.updateCities',cityId),{
        'status':newValue
    });
 };
                    ...
                    <tr v-for="city in cities.data" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            <label  class="inline-flex items-center cursor-pointer" >
                                <input v-model="city.status"  type="checkbox" class="sr-only peer" v-on:change="toggleStatus(city.id,city.status)">
