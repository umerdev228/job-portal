    ...
    <AdminLayout :auth="auth" :notifications="notifications">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <ul class="inline-flex -space-x-px text-sm">
                <li>
                    <Component :is="skills.links[0].url ? Link : 'span'"
                               :class="{ 'font-bold': skills.links[0].active, 'hover:text-white hover:font-bold': skills.links[0].active }"
                               :href="skills.links[0].url"
                               ...
                               v-html="skills.links[0].label"/>
                </li>
                <li v-for="(link, index) in skills.links.slice(1, -1)" :key="index">
                ...
                <li>
                    <Component :is="skills.links.slice(-1)[0].url ? Link : 'span'"
                               :class="{ 'font-bold': skills.links.slice(-1)[0].active, 'hover:text-white hover:font-bold': skills.links.slice(-1)[0].active }"
                               :href="skills.links.slice(-1)[0].url"
                               class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                               v-html="skills.links.slice(-1)[0].label"/>
                </li>
            </ul>
        </nav>
