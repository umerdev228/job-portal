    ...
    <AdminLayout :auth="auth" :notifications="notifications">
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tr  v-for="university in universities.data" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4 text-right flex">
                            ...
                            <Link class="font-medium text-blue-600 dark:text-blue-500 hover:underline" :href="route('admin.universities.destroy',university.id)" method="delete" >
        ...
        <nav aria-label="Page navigation example" class="mt-6">
            <ul class="inline-flex -space-x-px text-sm">
                <li>
                    <Component :is="universities.links[0].url ? Link : 'span'"
                               :class="{ 'font-bold': universities.links[0].active, 'hover:text-white hover:font-bold': universities.links[0].active }"
                               :href="universities.links[0].url"
                               ...
                               v-html="universities.links[0].label"/>
                </li>
                <li v-for="(link, index) in universities.links.slice(1, -1)" :key="index">
                ...
                <li>
                    <Component :is="universities.links.slice(-1)[0].url ? Link : 'span'"
                               :class="{ 'font-bold': universities.links.slice(-1)[0].active, 'hover:text-white hover:font-bold': universities.links.slice(-1)[0].active }"
                               :href="universities.links.slice(-1)[0].url"
                               class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                               v-html="universities.links.slice(-1)[0].label"/>
                </li>
            </ul>
        </nav>
